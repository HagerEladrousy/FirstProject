...
export default function App({navigation }) {
  ...
  return (
    <LinearGradient
      ...
      <Text style={{position:'absolute',top:200,fontWeight:'bold',fontSize:19,textAlign:'center'}}>Enter fasting blood sugar</Text>
     ...
     <TouchableOpacity style={styles.Button} onPress={() => navigation.navigate('Low')}>
