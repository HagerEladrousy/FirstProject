...
export default function VeryLow() {
  const [suggestions, setSuggestions] = useState('');

  useEffect(() => {
    const fetchSuggestions = async () => {
      setSuggestions('Fetching meal suggestions...');
      const response = await getMealSuggestions(50); // Example value for Very Low sugar
  ...
  return (
    <LinearGradient colors={['#8B4513', '#D2691E']} style={styles.gradient}>
