...
export default function Normal() {
  ...
  useEffect(() => {
    const fetchSuggestions = async () => {
      ...
      const response = await getMealSuggestions(100); // Example value for Normal sugar
  ...
  return (
    <LinearGradient colors={['#228B22', '#32CD32']} style={styles.gradient}>
      <View style={styles.container}>
        <Image source={logo} style={styles.logo} />
        <Image source={profilecircle} style={styles.profilecircle} />

        <Text style={styles.text}>Normal Sugar</Text>
