...
export default function VeryHigh() {
  const [suggestions, setSuggestions] = useState('');

  useEffect(() => {
    const fetchSuggestions = async () => {
      setSuggestions('Fetching meal suggestions...');
      const response = await getMealSuggestions(200); // Example value for Very High sugar
  ...
  return (
    <LinearGradient colors={['#8B0000', '#FF0000']} style={styles.gradient}>
