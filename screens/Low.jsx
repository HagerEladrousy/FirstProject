...
export default function Low() {
  ...
  useEffect(() => {
    const fetchSuggestions = async () => {
      ...
      const response = await getMealSuggestions(70); // Example value for Low sugar
  ...
  return (
    <LinearGradient colors={['#FF8800', '#FF4500']} style={styles.gradient}>
      <View style={styles.container}>
        <Image source={logo} style={styles.logo} />
        <Image source={profilecircle} style={styles.profilecircle} />

        <Text style={styles.text}>Low Sugar</Text>
