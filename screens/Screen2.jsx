  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.Button} onPress={() => navigation.navigate('Doctorsignin')}>
          <Text style={styles.buttonText}>Sign In</Text>
          <Image source={Sign_in_circle} style={styles.image}></Image>
        </TouchableOpacity>
    
        <TouchableOpacity style={styles.Button2} onPress={() => navigation.navigate('Doctorsignup')}>
